...
export const Header = () => {
    return (
        ...
        <div className=''>
            ...
            <nav
                className="z-20 flex  justify-around gap-4 border-t border-gray-200 bg-white/50 p-2.5 shadow-lg backdrop-blur-lg dark:border-slate-600/60 dark:bg-slate-800/50 fixed top-2/4 -translate-y-2/4 left-6 min-h-[300px] min-w-[100px] flex-col rounded-lg border items-center"
            >
                ...
                <Link
                    href="#about"
                    className="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-md p-1.5 text-gray-100 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-slate-800"
                >
